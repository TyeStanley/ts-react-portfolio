          ...
          <form onSubmit={submitHandler}>
            ...
            >
              <FormControl fullWidth required>
                ...
                <OutlinedInput
                  ...
                  required
                />
                 <FormHelperText id="my-helper-text" sx={{ color: '#d8364c' }}>{nameError}</FormHelperText>
              </FormControl>
            </Box>
            ...
            >
              <FormControl fullWidth required>
                ...
                <OutlinedInput
                  ...
                  required
                />
                <FormHelperText id="my-helper-text" sx={{ color: '#d8364c' }}>{emailError}</FormHelperText>
              </FormControl>
            </Box>
            ...
            <FormControl fullWidth>
              <TextField 
                ...
                fullWidth
              />
              <FormHelperText id="my-helper-text" sx={{ color: '#d8364c', paddingLeft: 1.5}}>{messageError}</FormHelperText>
            </FormControl>
            ...
            <p style={{color: 'green', marginTop: 5}}>{send ? 'Message has been successfully sent!' : ''}</p>
      ...
      <div className="backdrop">
        <div className="backnav">
          <div className="navigator">
            ...
            <Link class="navItem active" to="/contact">Contact</Link>
          </div>
        </div>
      </div>
    </div>
